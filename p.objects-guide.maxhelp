{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 83.0, 102.0, 396.0, 341.0 ],
		"bglocked" : 0,
		"defrect" : [ 83.0, 102.0, 396.0, 341.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numinlets" : 2,
					"patching_rect" : [ 16.0, 240.0, 82.0, 18.0 ],
					"id" : "obj-33",
					"numoutlets" : 1,
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"patching_rect" : [ 126.0, 241.0, 121.0, 18.0 ],
					"id" : "obj-32",
					"numoutlets" : 1,
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"bgcolor" : [ 0.827451, 0.827451, 0.827451, 1.0 ],
					"numinlets" : 2,
					"patching_rect" : [ 126.0, 311.0, 56.0, 18.0 ],
					"id" : "obj-30",
					"numoutlets" : 1,
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"bgcolor" : [ 0.827451, 0.827451, 0.827451, 1.0 ],
					"numinlets" : 2,
					"patching_rect" : [ 126.0, 265.0, 94.0, 18.0 ],
					"id" : "obj-28",
					"numoutlets" : 1,
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"bgcolor" : [ 0.827451, 0.827451, 0.827451, 1.0 ],
					"numinlets" : 2,
					"patching_rect" : [ 270.0, 147.0, 109.0, 18.0 ],
					"id" : "obj-22",
					"numoutlets" : 1,
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numinlets" : 2,
					"patching_rect" : [ 270.0, 101.0, 113.0, 18.0 ],
					"id" : "obj-12",
					"numoutlets" : 1,
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numinlets" : 2,
					"patching_rect" : [ 270.0, 78.0, 87.0, 18.0 ],
					"id" : "obj-14",
					"numoutlets" : 1,
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"bgcolor" : [ 0.827451, 0.827451, 0.827451, 1.0 ],
					"numinlets" : 2,
					"patching_rect" : [ 270.0, 124.0, 113.0, 18.0 ],
					"id" : "obj-15",
					"numoutlets" : 1,
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 14.0,
					"numinlets" : 1,
					"patching_rect" : [ 269.0, 52.0, 55.0, 23.0 ],
					"id" : "obj-20",
					"numoutlets" : 0,
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"patching_rect" : [ 261.0, 48.0, 129.0, 287.0 ],
					"id" : "obj-21",
					"numoutlets" : 0
				}
...
, 			{
				"box" : 				{
					...
					"bgcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"numinlets" : 1,
					"patching_rect" : [ 117.0, 48.0, 136.0, 287.0 ],
					"id" : "obj-19",
					"numoutlets" : 0
				}
...
, 			{
				"box" : 				{
					...
					"bgcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"numinlets" : 1,
					"patching_rect" : [ 5.0, 48.0, 104.0, 287.0 ],
					"id" : "obj-13",
					"numoutlets" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"background" : 1,
					"patching_rect" : [ 5.0, 5.0, 386.0, 37.0 ],
					"id" : "obj-16",
					"numoutlets" : 0
				}
