{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 691.0, 79.0, 376.0, 286.0 ],
		"bglocked" : 0,
		"defrect" : [ 691.0, 79.0, 376.0, 286.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "see p.iscoordinblox.f for floats",
					"id" : "obj-27",
					"fontname" : "Arial",
					"fontsize" : 11.0,
					"numinlets" : 1,
					"patching_rect" : [ 220.0, 1.0, 155.0, 19.0 ],
					"numoutlets" : 0
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 11.0,
					"numinlets" : 1,
					"patching_rect" : [ 165.0, 187.0, 129.0, 32.0 ],
					"numoutlets" : 0
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numinlets" : 1,
					"patching_rect" : [ 88.0, 168.0, 60.0, 20.0 ],
					"numoutlets" : 1,
					"outlettype" : [ "bang" ]
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numinlets" : 2,
					"patching_rect" : [ 88.0, 193.0, 74.0, 18.0 ],
					"numoutlets" : 1,
					"outlettype" : [ "" ]
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numinlets" : 2,
					"patching_rect" : [ 13.0, 216.0, 94.0, 20.0 ],
					"numoutlets" : 1,
