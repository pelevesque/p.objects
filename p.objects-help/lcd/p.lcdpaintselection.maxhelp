{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 539.0, 127.0, 472.0, 470.0 ],
		"bglocked" : 0,
		"defrect" : [ 539.0, 127.0, 472.0, 470.0 ],
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "Note: lcdmultirectselect and lcdhoverselection must have the same namespace as lcepaintselection.",
					"linecount" : 2,
					"fontsize" : 11.0,
					"patching_rect" : [ 12.0, 431.0, 266.0, 32.0 ],
					"id" : "obj-9",
					"numinlets" : 1,
					"numoutlets" : 0,
					"fontname" : "Arial"
...
, 			{
				"box" : 				{
					...
					"linecount" : 3,
					"fontsize" : 11.0,
					"patching_rect" : [ 215.0, 150.0, 165.0, 44.0 ],
					"id" : "obj-19",
					"numinlets" : 1,
					"numoutlets" : 0,
					"fontname" : "Arial"
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
					"patching_rect" : [ 78.0, 359.0, 229.0, 20.0 ],
					"id" : "obj-6",
					"numinlets" : 2,
					"numoutlets" : 1,
					"fontname" : "Arial"
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
					"patching_rect" : [ 79.0, 304.0, 163.0, 20.0 ],
					"id" : "obj-2",
					"numinlets" : 1,
					"numoutlets" : 1,
					"fontname" : "Arial"
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "Note: This object is used in tandem with p.lcdhoverselection and p.lcdmultirectselect.",
					"fontsize" : 11.0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"fontsize" : 12.0,
					"patching_rect" : [ 24.0, 331.0, 241.0, 20.0 ],
					"id" : "obj-17",
					"numinlets" : 3,
					"numoutlets" : 1,
					"fontname" : "Arial"
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-6", 1 ],
					"hidden" : 0,
					"midpoints" : [ 244.5, 294.0, 297.5, 294.0 ]
				}
