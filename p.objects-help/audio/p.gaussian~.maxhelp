{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 439.0, 67.0, 379.0, 407.0 ],
		"bglocked" : 0,
		"defrect" : [ 439.0, 67.0, 379.0, 407.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"linecount" : 3,
					"patching_rect" : [ 29.0, 215.0, 269.0, 44.0 ],
					"fontsize" : 11.0,
					"id" : "obj-25",
					"numinlets" : 1,
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 89.0, 161.0, 60.0, 20.0 ],
					"maximum" : 0.5,
					"fontsize" : 12.0,
					"id" : "obj-4",
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					...
					"text" : "pcontrol",
					"outlettype" : [ "" ],
					"patching_rect" : [ 257.0, 324.0, 53.0, 20.0 ],
					"fontsize" : 12.0,
					"hidden" : 1,
					"id" : "obj-10",
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"patching_rect" : [ 257.0, 302.0, 118.0, 18.0 ],
					"fontsize" : 12.0,
					"hidden" : 1,
					"id" : "obj-12",
					"numinlets" : 2,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"patching_rect" : [ 273.0, 377.0, 92.0, 18.0 ],
					"fontsize" : 12.0,
					"id" : "obj-13",
					"numinlets" : 2,
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"text" : "p.gaussian~ 0.3",
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 12.0, 187.0, 96.0, 20.0 ],
					"fontsize" : 12.0,
					"id" : "obj-17",
					"numinlets" : 2,
					"fontname" : "Arial",
