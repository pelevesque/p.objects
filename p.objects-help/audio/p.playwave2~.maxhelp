{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 418.0, 118.0, 322.0, 319.0 ],
		"bglocked" : 0,
		"defrect" : [ 418.0, 118.0, 322.0, 319.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "wave~ based stereo file playback.",
					"id" : "obj-19",
					"fontname" : "Arial",
					"numinlets" : 1,
					"fontsize" : 12.754705,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"fontsize" : 12.0,
					"patching_rect" : [ 218.0, 287.0, 92.0, 18.0 ],
					"numoutlets" : 1,
					"outlettype" : [ "" ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"fontsize" : 11.0,
					"patching_rect" : [ 67.0, 254.0, 139.0, 32.0 ],
					"numoutlets" : 0
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-1",
					"numinlets" : 2,
					"patching_rect" : [ 14.0, 255.0, 45.0, 45.0 ],
					"numoutlets" : 0
				}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "p.playwave2~ big",
					"id" : "obj-17",
					"fontname" : "Arial",
					"numinlets" : 1,
					"fontsize" : 12.0,
					"patching_rect" : [ 14.0, 218.0, 104.0, 20.0 ],
					"numoutlets" : 2,
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-1", 1 ],
					"hidden" : 0,
					"midpoints" : [ 108.5, 244.0, 49.5, 244.0 ]
				}
