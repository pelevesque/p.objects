{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 593.0, 188.0, 523.0, 308.0 ],
		"bglocked" : 0,
		"defrect" : [ 593.0, 188.0, 523.0, 308.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"linecount" : 2,
					"fontname" : "Arial",
					"patching_rect" : [ 78.0, 266.0, 152.0, 34.0 ],
					"fontsize" : 12.0,
					"numinlets" : 1,
					"id" : "obj-15",
					"numoutlets" : 0
...
, 			{
				"box" : 				{
					...
					"text" : "signal",
					"fontname" : "Arial",
					"patching_rect" : [ 15.0, 255.0, 43.0, 20.0 ],
					"fontsize" : 12.0,
					"numinlets" : 1,
					"id" : "obj-31",
					"numoutlets" : 0
...
, 			{
				"box" : 				{
					"maxclass" : "button",
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 176.0, 203.0, 20.0, 20.0 ],
					"numinlets" : 1,
					"id" : "obj-29",
					"numoutlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"text" : "play state",
					"fontname" : "Arial",
					"patching_rect" : [ 174.0, 238.0, 62.0, 20.0 ],
					"fontsize" : 12.0,
					"numinlets" : 1,
					"id" : "obj-28",
					"numoutlets" : 0
...
, 			{
				"box" : 				{
					"maxclass" : "toggle",
					"outlettype" : [ "int" ],
					"patching_rect" : [ 199.0, 203.0, 33.0, 33.0 ],
					"numinlets" : 1,
					"id" : "obj-3",
					"numoutlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"hidden" : 1,
					"patching_rect" : [ 389.0, 197.0, 20.0, 20.0 ],
					"numinlets" : 1,
					"id" : "obj-7",
					"numoutlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"hidden" : 1,
					"patching_rect" : [ 389.0, 245.0, 53.0, 20.0 ],
					"fontsize" : 12.0,
					"numinlets" : 1,
					"id" : "obj-10",
					"numoutlets" : 1
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"hidden" : 1,
					"patching_rect" : [ 389.0, 223.0, 118.0, 18.0 ],
					"fontsize" : 12.0,
					"numinlets" : 2,
					"id" : "obj-12",
					"numoutlets" : 1
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"fontname" : "Arial",
					"patching_rect" : [ 417.0, 275.0, 92.0, 18.0 ],
					"fontsize" : 12.0,
					"numinlets" : 2,
					"id" : "obj-13",
					"numoutlets" : 1
...
, 			{
				"box" : 				{
					"maxclass" : "ezdac~",
					"patching_rect" : [ 15.0, 208.0, 45.0, 45.0 ],
					"numinlets" : 2,
					"id" : "obj-1",
					"numoutlets" : 0
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-5", 0 ],
					"hidden" : 0,
					"midpoints" : [ 300.5, 200.0, 276.5, 200.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 208.5, 199.0, 185.5, 199.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-1", 0 ],
					"hidden" : 0,
					"midpoints" : [ 116.5, 201.0, 24.5, 201.0 ]
				}
