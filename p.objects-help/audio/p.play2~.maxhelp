{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 1372.0, 299.0, 459.0, 288.0 ],
		"bglocked" : 0,
		"defrect" : [ 1372.0, 299.0, 459.0, 288.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 137.0, 213.0, 20.0, 20.0 ],
					"id" : "obj-29",
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 12.0,
					"patching_rect" : [ 135.0, 248.0, 62.0, 20.0 ],
					"fontname" : "Arial",
					"id" : "obj-28",
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 160.0, 213.0, 33.0, 33.0 ],
					"id" : "obj-3",
					"numinlets" : 1
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 169.166672, 209.0, 146.5, 209.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-1", 1 ],
					"hidden" : 0,
					"midpoints" : [ 96.833336, 208.0, 50.5, 208.0 ]
				}
