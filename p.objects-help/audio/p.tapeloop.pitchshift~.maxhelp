...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 101.0, 271.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 18.0, 152.0, 39.0, 22.0 ],
					"text" : "* 200"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 18.0, 127.0, 61.0, 22.0 ],
					"text" : "random 9"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 42.0, 73.0, 60.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 18.0, 100.0, 65.0, 22.0 ],
					"text" : "metro 200"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 18.0, 177.0, 45.0, 22.0 ],
					"text" : "cycle~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 43.0, 211.0, 37.0, 22.0 ],
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 283.0, 363.0, 97.0, 43.0 ],
					"text" : "mix (def: 0.)\n-1. = clean signal\n1. = delay signal"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 85.0, 422.0, 257.0, 68.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 200.0, 300.0, 230.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "float" ],
					"patching_rect" : [ 183.0, 338.0, 56.0, 22.0 ],
					"sig" : 0.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "float" ],
					"patching_rect" : [ 142.0, 305.0, 56.0, 22.0 ],
					"sig" : 0.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 19.0, 396.0, 224.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 8.0, 4.0, 238.0, 30.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 276.0, 197.0, 53.0, 22.0 ],
					"text" : "pcontrol"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 276.0, 175.0, 118.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 388.0, 471.0, 92.0, 22.0 ],
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "p.tapeloop.pitchshift~.maxpat",
...
, 			{
				"name" : "p.pitchshift.gizmo~.maxpat",
				"bootpath" : "~/Documents/Repos/p.objects/p.objects-abstractions/audio/p.pitchshift.gizmo~",
				"patcherrelativepath" : "../../p.objects-abstractions/audio/p.pitchshift.gizmo~",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				"name" : "p.pitchshift.gizmo_loadme~.maxpat",
				"bootpath" : "~/Documents/Repos/p.objects/p.objects-abstractions/audio/p.pitchshift.gizmo~",
				"patcherrelativepath" : "../../p.objects-abstractions/audio/p.pitchshift.gizmo~",
				"type" : "JSON",
				"implicit" : 1
