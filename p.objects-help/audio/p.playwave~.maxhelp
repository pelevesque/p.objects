{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 1365.0, 120.0, 358.0, 220.0 ],
		"bglocked" : 0,
		"defrect" : [ 1365.0, 120.0, 358.0, 220.0 ],
...
, 			{
				"box" : 				{
					...
					"hidden" : 1,
					"numoutlets" : 1,
					"patching_rect" : [ 236.0, 165.0, 53.0, 20.0 ],
					"fontsize" : 12.0,
					"outlettype" : [ "" ]
				}
...
, 			{
				"box" : 				{
					...
					"hidden" : 1,
					"numoutlets" : 1,
					"patching_rect" : [ 236.0, 143.0, 118.0, 18.0 ],
					"fontsize" : 12.0,
					"outlettype" : [ "" ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 1,
					"patching_rect" : [ 255.0, 190.0, 92.0, 18.0 ],
					"fontsize" : 12.0,
					"outlettype" : [ "" ]
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "arg: unique tag (required)",
					"linecount" : 2,
					"id" : "obj-8",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 114.0, 134.0, 92.0, 34.0 ],
					"fontsize" : 12.0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 1,
					"patching_rect" : [ 13.0, 135.0, 97.0, 20.0 ],
					"fontsize" : 12.0,
					"outlettype" : [ "signal" ]
				}
