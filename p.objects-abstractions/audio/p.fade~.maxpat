{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 496.0, 126.0, 309.0, 350.0 ],
		"bglocked" : 0,
		"defrect" : [ 496.0, 126.0, 309.0, 350.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"id" : "obj-33",
					"patching_rect" : [ 113.0, 220.0, 34.0, 20.0 ],
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 2
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"id" : "obj-24",
					"patching_rect" : [ 59.0, 118.0, 87.0, 20.0 ],
					"numinlets" : 2,
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"id" : "obj-10",
					"patching_rect" : [ 128.0, 248.0, 73.0, 20.0 ],
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"id" : "obj-22",
					"patching_rect" : [ 136.0, 329.0, 171.0, 18.0 ],
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 0
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 11.0,
					"id" : "obj-17",
					"patching_rect" : [ 155.0, 282.0, 117.0, 19.0 ],
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 0
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 11.0,
					"id" : "obj-9",
					"patching_rect" : [ 189.0, 92.0, 86.0, 19.0 ],
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 0
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 11.0,
					"id" : "obj-8",
					"patching_rect" : [ 86.0, 50.0, 64.0, 19.0 ],
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 0
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 11.0,
					"id" : "obj-7",
					"patching_rect" : [ 45.0, 267.0, 54.0, 19.0 ],
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 0
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 11.0,
					"id" : "obj-6",
					"patching_rect" : [ 45.0, 20.0, 50.0, 19.0 ],
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 0
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"id" : "obj-5",
					"patching_rect" : [ 59.0, 160.0, 63.0, 20.0 ],
					"numinlets" : 2,
					"fontname" : "Arial",
					"color" : [ 0.843137, 0.741176, 0.431373, 1.0 ],
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"id" : "obj-34",
					"patching_rect" : [ 184.0, 124.0, 91.0, 20.0 ],
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 2
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"id" : "obj-31",
					"patching_rect" : [ 162.0, 89.0, 25.0, 25.0 ],
					"numinlets" : 0,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"id" : "obj-29",
					"patching_rect" : [ 127.0, 160.0, 54.0, 20.0 ],
					"numinlets" : 2,
					"fontname" : "Arial",
					"color" : [ 0.843137, 0.741176, 0.431373, 1.0 ],
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "outlet",
					"id" : "obj-28",
					"patching_rect" : [ 128.0, 279.0, 25.0, 25.0 ],
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"id" : "obj-25",
					"patching_rect" : [ 59.0, 47.0, 25.0, 25.0 ],
					"numinlets" : 0,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"id" : "obj-4",
					"patching_rect" : [ 59.0, 193.0, 73.0, 20.0 ],
					"numinlets" : 2,
					"fontname" : "Arial",
					"numoutlets" : 2
				}
...
, 			{
				"box" : 				{
					"maxclass" : "outlet",
					"id" : "obj-2",
					"patching_rect" : [ 18.0, 264.0, 25.0, 25.0 ],
					"numinlets" : 1,
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"id" : "obj-1",
					"patching_rect" : [ 18.0, 230.0, 60.0, 20.0 ],
					"numinlets" : 2,
					"fontname" : "Arial",
					"numoutlets" : 1
				}
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"midpoints" : [ 193.5, 151.5, 112.5, 151.5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-5", 1 ],
					"hidden" : 0,
					"midpoints" : [ 171.5, 147.0, 112.5, 147.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-4", 0 ],
					"hidden" : 0,
					"midpoints" : [ 136.5, 186.5, 68.5, 186.5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"color" : [ 1.0, 0.337255, 0.619608, 1.0 ],
					"midpoints" : [ 193.5, 155.5, 171.5, 155.5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 122.5, 312.0, 281.0, 312.0, 281.0, 80.0, 136.5, 80.0 ]
				}
