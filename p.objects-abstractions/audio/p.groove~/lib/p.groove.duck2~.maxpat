{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 111.0, 140.0, 686.0, 519.0 ],
		"bglocked" : 0,
		"defrect" : [ 111.0, 140.0, 686.0, 519.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"numinlets" : 1,
					"patching_rect" : [ 137.0, 480.0, 58.0, 19.0 ],
					"numoutlets" : 0,
					"fontsize" : 11.0
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-23",
					"numinlets" : 1,
					"patching_rect" : [ 110.0, 477.0, 25.0, 25.0 ],
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"numinlets" : 2,
					"patching_rect" : [ 110.0, 442.0, 48.5, 20.0 ],
					"numoutlets" : 1,
					"fontsize" : 12.0,
					"outlettype" : [ "signal" ]
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"numinlets" : 1,
					"patching_rect" : [ 551.0, 166.0, 125.0, 70.0 ],
					"numoutlets" : 0,
					"fontsize" : 11.0
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"numinlets" : 1,
					"patching_rect" : [ 513.0, 499.0, 171.0, 18.0 ],
					"numoutlets" : 0,
					"fontsize" : 10.0
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"numinlets" : 1,
					"patching_rect" : [ 211.0, 369.0, 55.0, 19.0 ],
					"numoutlets" : 0,
					"fontsize" : 11.0
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"numinlets" : 1,
					"patching_rect" : [ 40.0, 480.0, 58.0, 19.0 ],
					"numoutlets" : 0,
					"fontsize" : 11.0
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-4",
					"numinlets" : 1,
					"patching_rect" : [ 14.0, 477.0, 25.0, 25.0 ],
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"numinlets" : 3,
					"patching_rect" : [ 140.0, 403.0, 62.0, 20.0 ],
					"numoutlets" : 1,
					"fontsize" : 12.0,
					"outlettype" : [ "signal" ]
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-7",
					"numinlets" : 1,
					"patching_rect" : [ 185.0, 367.0, 25.0, 25.0 ],
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"numinlets" : 2,
					"patching_rect" : [ 14.0, 441.0, 41.5, 20.0 ],
					"numoutlets" : 1,
					"fontsize" : 12.0,
					"outlettype" : [ "signal" ]
				}
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"midpoints" : [ 86.5, 401.0, 119.5, 401.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 149.5, 429.0, 149.0, 429.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-7", 0 ],
					"hidden" : 0,
					"midpoints" : [ 149.5, 324.0, 194.5, 324.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-3", 1 ],
					"hidden" : 0,
					"midpoints" : [ 149.5, 429.5, 46.0, 429.5 ]
				}
