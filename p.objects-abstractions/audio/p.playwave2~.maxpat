{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 135.0, 140.0, 353.0, 311.0 ],
		"bglocked" : 0,
		"defrect" : [ 135.0, 140.0, 353.0, 311.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"fontsize" : 11.0,
					"patching_rect" : [ 285.0, 249.0, 49.0, 19.0 ],
					"numoutlets" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"fontsize" : 11.0,
					"patching_rect" : [ 205.0, 249.0, 49.0, 19.0 ],
					"numoutlets" : 0
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-5",
					"numinlets" : 1,
					"patching_rect" : [ 258.0, 247.0, 25.0, 25.0 ],
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"fontsize" : 12.0,
					"patching_rect" : [ 110.0, 90.0, 63.0, 20.0 ],
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"fontsize" : 10.0,
					"patching_rect" : [ 180.0, 291.0, 171.0, 18.0 ],
					"numoutlets" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"fontsize" : 12.0,
					"patching_rect" : [ 178.0, 90.0, 43.0, 20.0 ],
					"numoutlets" : 1,
					"outlettype" : [ "" ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"fontsize" : 12.0,
					"patching_rect" : [ 265.0, 144.0, 32.5, 18.0 ],
					"numoutlets" : 1,
					"outlettype" : [ "" ]
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-23",
					"numinlets" : 1,
					"patching_rect" : [ 178.0, 247.0, 25.0, 25.0 ],
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 3,
					"fontsize" : 12.0,
					"patching_rect" : [ 178.0, 215.0, 99.0, 20.0 ],
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"fontsize" : 12.0,
					"patching_rect" : [ 178.0, 181.0, 56.0, 20.0 ],
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"fontsize" : 12.0,
					"patching_rect" : [ 178.0, 148.0, 54.0, 18.0 ],
					"numoutlets" : 1,
					"outlettype" : [ "" ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"fontsize" : 12.0,
					"patching_rect" : [ 178.0, 122.0, 75.0, 20.0 ],
					"numoutlets" : 1,
					"outlettype" : [ "" ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 274.5, 174.5, 187.5, 174.5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-1", 1 ],
					"hidden" : 0,
					"midpoints" : [ 224.5, 206.0, 258.0, 206.0, 258.0, 84.0, 211.5, 84.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-18", 0 ],
					"hidden" : 0,
					"midpoints" : [ 23.5, 116.5, 187.5, 116.5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-1", 0 ],
					"hidden" : 0,
					"midpoints" : [ 55.5, 84.0, 187.5, 84.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 87.5, 78.0, 274.5, 78.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-18", 0 ],
					"hidden" : 0,
					"midpoints" : [ 119.5, 116.0, 187.5, 116.0 ]
				}
