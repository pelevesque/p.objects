{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 96.0, 70.0, 568.0, 342.0 ],
		"bglocked" : 0,
		"defrect" : [ 96.0, 70.0, 568.0, 342.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"text" : "clip~ 0. 1.",
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 17.0, 246.0, 62.0, 20.0 ],
					"fontsize" : 12.0,
					"id" : "obj-19",
					"numinlets" : 3,
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 134.0, 136.0, 151.0, 19.0 ],
					"fontsize" : 11.0,
					"id" : "obj-18",
					"numinlets" : 1,
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"patching_rect" : [ 68.0, 113.0, 218.0, 20.0 ],
					"fontsize" : 12.0,
					"id" : "obj-50",
					"numinlets" : 1,
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 101.0, 71.0, 94.0, 20.0 ],
					"fontsize" : 12.0,
					"id" : "obj-12",
					"numinlets" : 1,
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"linecount" : 3,
					"patching_rect" : [ 300.0, 98.0, 260.0, 44.0 ],
					"fontsize" : 11.0,
					"id" : "obj-17",
					"numinlets" : 1,
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"linecount" : 8,
					"patching_rect" : [ 300.0, 151.0, 260.0, 108.0 ],
					"fontsize" : 11.0,
					"id" : "obj-16",
					"numinlets" : 1,
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "y = ((x - 0.5)²  *  -4p)  +  p",
					"patching_rect" : [ 300.0, 69.0, 152.0, 20.0 ],
					"fontsize" : 12.0,
					"id" : "obj-14",
					"numinlets" : 1,
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 395.0, 323.0, 171.0, 18.0 ],
					"fontsize" : 10.0,
					"id" : "obj-11",
					"numinlets" : 1,
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 94.0, 23.0, 91.0, 19.0 ],
					"fontsize" : 11.0,
					"id" : "obj-7",
					"numinlets" : 1,
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"text" : "* -4.",
					"outlettype" : [ "float" ],
					"patching_rect" : [ 68.0, 149.0, 33.0, 20.0 ],
					"fontsize" : 12.0,
					"id" : "obj-5",
					"numinlets" : 2,
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"text" : "*~",
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 17.0, 149.0, 38.5, 20.0 ],
					"fontsize" : 12.0,
					"id" : "obj-9",
					"numinlets" : 2,
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"text" : "+~",
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 17.0, 214.0, 101.5, 20.0 ],
					"fontsize" : 12.0,
					"id" : "obj-15",
					"numinlets" : 2,
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"text" : "*~",
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 17.0, 181.0, 69.5, 20.0 ],
					"fontsize" : 12.0,
					"id" : "obj-10",
					"numinlets" : 2,
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"text" : "-~ 0.5",
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 17.0, 108.0, 42.0, 20.0 ],
					"fontsize" : 12.0,
					"id" : "obj-3",
					"numinlets" : 2,
					"fontname" : "Arial",
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-50", 0 ],
					"hidden" : 0,
					"midpoints" : [ 110.5, 104.0, 77.5, 104.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-9", 1 ],
					"hidden" : 0,
					"midpoints" : [ 26.5, 138.0, 46.0, 138.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 77.5, 141.5, 109.0, 141.5 ]
				}
