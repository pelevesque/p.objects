{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 207.0, 232.0, 471.0, 344.0 ],
		"bglocked" : 0,
		"defrect" : [ 207.0, 232.0, 471.0, 344.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 3,
					"fontsize" : 12.0,
					"patching_rect" : [ 102.0, 126.0, 83.0, 20.0 ],
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 618.0, 124.0, 640.0, 480.0 ],
						"bglocked" : 0,
						"defrect" : [ 618.0, 124.0, 640.0, 480.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"id" : "obj-5",
									"numinlets" : 0,
									"patching_rect" : [ 236.0, 54.0, 25.0, 25.0 ],
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"comment" : ""
								}
...
, 							{
								"box" : 								{
									...
									"id" : "obj-4",
									"numinlets" : 0,
									"patching_rect" : [ 271.0, 186.0, 25.0, 25.0 ],
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"comment" : ""
								}
...
, 							{
								"box" : 								{
									...
									"id" : "obj-2",
									"numinlets" : 1,
									"patching_rect" : [ 207.0, 289.0, 25.0, 25.0 ],
									"numoutlets" : 0,
									"comment" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 2,
									"fontsize" : 12.0,
									"patching_rect" : [ 207.0, 129.0, 43.0, 20.0 ],
									"numoutlets" : 1,
									"outlettype" : [ "" ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 2,
									"fontsize" : 12.0,
									"patching_rect" : [ 253.0, 218.0, 32.5, 18.0 ],
									"numoutlets" : 1,
									"outlettype" : [ "" ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 2,
									"fontsize" : 12.0,
									"patching_rect" : [ 207.0, 251.0, 56.0, 20.0 ],
									"numoutlets" : 2,
...
, 							{
								"box" : 								{
									...
									"numinlets" : 2,
									"fontsize" : 12.0,
									"patching_rect" : [ 207.0, 191.0, 54.0, 18.0 ],
									"numoutlets" : 1,
									"outlettype" : [ "" ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"fontsize" : 12.0,
									"patching_rect" : [ 207.0, 165.0, 75.0, 20.0 ],
									"numoutlets" : 1,
									"outlettype" : [ "" ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 262.5, 240.5, 216.5, 240.5 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"destination" : [ "obj-1", 1 ],
									"hidden" : 0,
									"midpoints" : [ 253.5, 279.0, 304.0, 279.0, 304.0, 123.0, 240.5, 123.0 ]
								}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"fontsize" : 12.0,
					"patching_rect" : [ 227.0, 120.0, 144.0, 20.0 ],
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"fontsize" : 11.0,
					"patching_rect" : [ 343.0, 234.0, 56.0, 19.0 ],
					"numoutlets" : 0
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-12",
					"numinlets" : 1,
					"patching_rect" : [ 315.0, 232.0, 25.0, 25.0 ],
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"fontsize" : 11.0,
					"patching_rect" : [ 379.0, 84.0, 53.0, 19.0 ],
					"numoutlets" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"fontsize" : 11.0,
					"patching_rect" : [ 254.0, 84.0, 56.0, 19.0 ],
					"numoutlets" : 0
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-8",
					"numinlets" : 0,
					"patching_rect" : [ 352.0, 81.0, 25.0, 25.0 ],
					"numoutlets" : 1,
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					...
					"id" : "obj-7",
					"numinlets" : 0,
					"patching_rect" : [ 227.0, 81.0, 25.0, 25.0 ],
					"numoutlets" : 1,
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"fontsize" : 12.0,
					"patching_rect" : [ 20.0, 92.0, 63.0, 20.0 ],
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"color" : [ 0.843137, 0.741176, 0.431373, 1.0 ],
					"patcher" : 					{
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"fontsize" : 11.0,
					"patching_rect" : [ 129.0, 20.0, 63.0, 19.0 ],
					"numoutlets" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"fontsize" : 11.0,
					"patching_rect" : [ 128.0, 195.0, 56.0, 19.0 ],
					"numoutlets" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"fontsize" : 10.0,
					"patching_rect" : [ 248.0, 268.0, 171.0, 18.0 ],
					"numoutlets" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 3,
					"fontsize" : 12.0,
					"patching_rect" : [ 102.0, 160.0, 269.0, 20.0 ],
					"numoutlets" : 1,
					"outlettype" : [ "signal" ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"fontsize" : 12.0,
					"patching_rect" : [ 102.0, 54.0, 115.0, 20.0 ],
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-27", 0 ],
					"hidden" : 0,
					"midpoints" : [ 29.5, 118.5, 111.5, 118.5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"color" : [ 1.0, 0.337255, 0.619608, 1.0 ],
					"midpoints" : [ 207.5, 85.5, 29.5, 85.5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-22", 2 ],
					"hidden" : 0,
					"midpoints" : [ 29.5, 222.0, 376.0, 222.0, 376.0, 154.0, 361.5, 154.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-12", 0 ],
					"hidden" : 0,
					"midpoints" : [ 29.5, 222.0, 324.5, 222.0 ]
				}
